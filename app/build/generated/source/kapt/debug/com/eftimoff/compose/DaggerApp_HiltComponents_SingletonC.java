...
import com.eftimoff.compose.injection.AppModule_ProvideReceiptApiFactory;
import com.eftimoff.compose.viewmodel.MainViewModel;
import com.eftimoff.compose.viewmodel.MainViewModel_HiltModules_KeyModule_ProvideFactory;
  ...
  private final class ActivityRetainedCImpl extends App_HiltComponents.ActivityRetainedC {
    ...
    private final class ViewModelCImpl extends App_HiltComponents.ViewModelC {
      ...
      private MainViewModel mainViewModel() {
        return new MainViewModel(AppModule_ProvideReceiptApiFactory.provideReceiptApi(DaggerApp_HiltComponents_SingletonC.this.appModule));
      }
      ...
      public Map<String, Provider<ViewModel>> getHiltViewModelMap() {
        return Collections.<String, Provider<ViewModel>>singletonMap("com.eftimoff.compose.viewmodel.MainViewModel", (Provider) mainViewModelProvider());
      }
      ...
      private final class SwitchingProvider<T> implements Provider<T> {
        ...
        public T get() {
          switch (id) {
            case 0: // com.eftimoff.compose.viewmodel.MainViewModel 
